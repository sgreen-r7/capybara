...
module Capybara
  module Node
    module Matchers
      ...
      #
      def assert_all_of_selectors(*args, wait: Capybara.default_max_wait_time, **options, &optional_filter_block)
      ...
      #
      def assert_none_of_selectors(*args, wait: Capybara.default_max_wait_time, **options, &optional_filter_block)
        selector = if args.first.is_a?(Symbol) then args.shift else Capybara.default_selector end
        synchronize(wait) do
          args.each do |locator|
